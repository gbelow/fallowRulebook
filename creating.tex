...
There are 26 skills, as described in the table:
...
Rhetoric & 0 & Intellect & yes \\
Manipulation & 0 & Intellect & yes \\
Will & SPI & Spirit & no \\
...
Skills marked as trainable can be improved individually.
...
% \textbf{Charisma (INT)}: General skill of communication. Uses INT as talent. \\
...
\textbf{Intellect (INT)}: Represents memory, logical reasoning, and attention management. Includes all knowledge, spells, exploration skills, and cunning in combat.

\textbf{Spirit (SPI)}: Represents the character's emotional self control, confidence, and ability to manifest its innate spiritual powers. It encompasses charisma, stress, will and acting, as well as abilities derived from conviction and devotions.
...
There are four skills relevant to social situations. Empathy, Composure, Rhetoric and Will.


\skill{ Empathy }{ Charisma }{ This is used to read character's intentions, understand their desires and emotions, as well their connection to behavior. Empathy can be used to detect when someone is lying, even when the logic makes sense.
