...
\begin{proplist}
    ...
    \item \textbf{Architecture:} Knowledge about structures, their common forms, how to build or destroy them. Tunnels, bridges, buildings. Helps with exploration inside buildings.
    \item \textbf{Chemistry:} Knowledge about chemicals and their craft. Includes bombs, acids, toxic substances.
    \item \textbf{Medicine:} can make autopsy, potions, poisons and everything from first aid to surgeury.
    ...
    \item \textbf{Survival:} This is the knowledge used in the action of exploration and preparation. It includes actions like cooking, butchering animals, preparing campfires, making natural shelters, and crafting simple objects from materials found in nature.
