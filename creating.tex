...
Knowledges are used mostly outside of combat. They are used as requisite to learn abilities, to interact with features during exploration, to enable and improve several downtime activities, and as a general measure of the character's intelligence.
...
\textbf{Knowledge test:} is equivalent to asking your character if they know or remember something from their studies. Use 2x the relevant knowledge as the skill value.
...
\textbf{Knowledge as Enabler:} Many actions require an amount of a certain knowledge to be able to be performed. Attempting to perform that without the necessary knowledge level leads to a penalty of -5 per missing knowledge level to whatever test was called.

\textbf{Ability requirement:} Some abilities are learned automatically at certain levels of the areas of knowledge. Some abilities cannot be learned without the proper knowledge requirement.
...
\textbf{Knowledge in magic:} There are three magic related areas of knowledge. They are used when casting and learning spells as a wizard. More details in the Sorcery chapter.
...
\begin{itemize}
    ...
    \item \magic Shamanism: Helps with finding spirits, diplomacy with them.  
    ...
    \item Chemistry: Knowledge about chemicals and their craft. Includes bombs, acids, toxic substances.
    \item Medicine: can make autopsy, potions, poisons and everything from first aid to surgeury.
    \item Geography: Allows map-making. Helps traveling skill. Make tests to guess where resource events should be.
    \item Politics: involves forgery, disguise, and acquiring local information about people.
    ...
    \item Zoology: Knowledge about animals. Helps with diplomacy with animals, hunting, finding weaknesses.
\end{itemize}
\noindent
