...
\textbf{Action Points (AP):} Action Points are a resource used to represent time. Actions cost AP to perform in situations where time is an important resource.
...
Force & STR-10 & - & no\\
% Agility & 2x (AGI-10) & Constitution & no\\
% Stamina & 2x (STA-10) & Constitution & no\\
\midrule
\rowcolor{fallowtint}
...
\textbf{Charisma (SPI)}: This is the ability to make people trust you. Uses SPI as talent. \\
\textbf{Conviction (SPI)}: Alignment of worldview and temperament. Uses SPI as talent for each conviction. \\
...
\textbf{Karma:} is used to increase talents and get special abilities. It is received upon completing missions and their secondary objectives, as well as being rewarded for good gameplay.
...
% \textbf{Attributes as skills:} sometimes, an attribute can be used as a skill. For example, strength for lifting weight and stamina for holding breath. In that case, use 2x(attribute -10) as the skill value.
...
\textbf{Reach Multiplier (RM):} multiplies the range of all weapons.
...
\textbf{\large Surbit}
\begin{proplist}
\item Small-sized creature: size 2
...
\textbf{Exploration:} It is used in survival situations to determine the ability to travel without getting lost and to find things in varied terrains. The exploration skill is based on the sum of awareness proficiency and specific knowledge of the area.
...
\begin{proplist}
    ...
    % \item \textbf{Building:} Knowledge about structures, their common forms, how to build or destroy them. Tunnels, bridges, buildings. Helps with exploration inside buildings.
    \item \textbf{Mechanics:} Knowledge about the manufacture and usage of traps, locks, siege engines and other mechanisms.
    \item \textbf{Smithing:} Knowledge about the manufacture, improvement and maintenance of weapons, armor and tools.
    \item \textbf{Chemistry:} Knowledge about chemicals and their craft. Includes bombs, flammables, acids, toxic substances.
    ...
    \item \textbf{Navigation:} Includes knowledge about geography and maps. It is important for navigation.  
    \item \textbf{Survival:} knowledge about the wilderness. It includes actions like cooking, hunting, tracking, butchering animals, preparing campfires, making natural shelters, and crafting simple objects from materials found in nature.
    \item \textbf{Animal Handling:} Knowledge about animals. Helps with diplomacy with animals, taming, finding weaknesses.
\end{proplist}
\noindent

The abilities section has several usages for each of the knowledges. Most are gained automatically with knowledge levels.
...
\subsection{Limit Stress Actions:}

Each character must choose a limit stress action.
...
\textbf{Violent:} is compelled to use their combat surge to inflict damage on someone. If STA is insuficient, rest and then surge if possible.
...
\textbf{Acquiring a conviction:} A character must adopt one worldview conviction and one temperament conviction during character creation. They start at level 0. Each has a defined way of gaining XP through the character's actions.
...
It is possible to lose conviction XP. If the session ends with negative XP, the conviction loses a level. Each conviction has its condition for XP loss. If the level is 0 and there is -4 XP, the conviction is considered renounced.

There are 8 convictions arranged along two axes: Extrospective - Introspective and Order - Chaos. 4 of them are worldview convictions and 4 are temperament convictions. The convictions are detailed in the abilities chapter.
...
Abilities: Synesthesia, Spiritual Strike, central intelligence, blind combat, psychoactive assistance, counterspell, martial spirit \\
...
% Convictions: Providentialism and Guardian \\
...
\textbf{Step 3: Wealth.} The character can buy anything except training with that money. Only 10\% of the money can be spared, the rest must be spent or lost. \\
A: 100 GP, \\
B: 60 GP, \\
C: 30 GP, \\
D: 10 GP, \\
...
\textbf{Step 4: CON.} Characters start with 8 in all attributes and receive XP to increase them. This XP can also be used for CON based abilities. \\
A. +2 CON, +60 XP. \\
B. +1 CON, +42 XP. \\
C. +1 CON, +30 XP.\\
D. +0 CON, +24 XP. \\
