...
\textbf{Action Points (AP):} Action Points are a resource used to represent time. Actions cost AP to perform in situations where time is an important resource. The amount of AP each character receives at the beginning of each round is 8.
...
\hline &&& \\
Health & Constitution & Constitution & yes\\
...
Sleight of Hand & Dexterity & Dexterity & yes \\
...
Devotion & SPI+Devotion & Spirit & no \\
Charm & 0 & Spirit & no \\
Stress & 0 & Spirit & no \\
Will & 0 & Spirit & no \\
Acting & SPI & Intellect & no \\
...
\textbf{Sorcery (INT)}: General skill in casting spells. Uses INT as talent. \\
\textbf{Conviction (SPI)}: Ability to control emotions and use them effectively. Uses SPI as talent. \\
\textbf{Devotion (SPI)}: Level of alignment with a deity. \\
...
\textbf{Constitution (CON)}: Represents the character's ability to adapt physically.
...
\textbf{Spirit (SPI)}: Represents the character's ability to understand and control consciousness. Includes charisma and will, as well as abilities derived from conviction and spirituality.
...
Neither charming nor intimidating are trainable as skills. The bonuses come from abilities and convictions.

\skill{ Charm }{ 0 }{ It is used in all social actions and spells that involve making others feel comfortable and trusting the character. People with high charm make better first impressions and appear more trustworthy and competent. }

\skill{ Stress }{ 0 }{ It is used in all social actions and spells that involve causing fear, anger, and conflict in general. People with high Stress make strong impressions. }

Each conviction provides bonuses to Charm, Stress, or Will based on its level.
