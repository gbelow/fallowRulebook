...
Skills marked as trainable can be improved individually. The ones that are not can only get bonuses from their proficiency. Skills where trainable is "knowledge" mean that the skill value is trainable, but follows the rules of the knowledges.
