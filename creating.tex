...
Strength & 2x(STR-10) & Constitution & yes \\
Agility & 2x(AGI-10) & Constitution & yes \\
Stamina & 2x(STA-10) & Constitution & yes \\
...
\textbf{Knowledge as a skill assist:} Some types of knowledge can be added to other skills, like detection to improve the chance of detecting something.
...
\textbf{Knowledge in magic:} There are three magic related knowledges. They are used when casting and learning spells as a wizard. More details in the Sorcery chapter.
