...
\begin{proplist}
    ...
    \item \textbf{Navigation:} Allows map-making. Helps traveling skill. Make tests to guess where resource events should be.
    ...
    \item \textbf{Animal handling:} Knowledge about animals. Helps with diplomacy with animals, taming, hunting, finding weaknesses.
\end{proplist}
\noindent
