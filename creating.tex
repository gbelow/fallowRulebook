...
It is possible to lose conviction XP. If the session ends with negative XP, the conviction loses a level. Each conviction has its condition for XP loss. If the level reaches 0, the conviction is considered renounced.

There are 8 convictions arranged along two axes: Extrospective - Introspective and Order - Chaos. 4 of them are worldview convictions and 4 are temperament convictions. The convictions are detailed in the chapter on skills.
