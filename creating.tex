...
\subsubsection{Specific Knowledge}

Informal knowledge is the result of the character's experiences and can be acquired by engaging in any activity. The categories can be diverse, created to represent the character's experiences. How it is gained, its levels, and why it's worth having are explained together with the Knowledge test in the Story chapter.
