...
\textbf{Acquiring contacts:} This can be done by completing missions, or by making an politics test to see how much time and money will be spent on acquiring this contact. The amount of time and money required depends on the relevance and utility of the contact.
...
Train - XP for + money, less XP alone
Job - +money 
Study - gain knowledge
Heal - excellent sleep - pay to heal faster
celebrate - gain popularity + local knowledge

\downtime{Training}{10 x N}{Trainer rate x days }{Trainer}{ none }{ N XP }

\downtime{Training without trainer}{10 x N}{ variable }{ - }{ 2x talent vs 2x training level }{ miss = 0 XP - graze = $N/4$ XP - hit $N/2$ XP - crit N XP }

\downtime{Job}{ N days }{ - }{Employer}{ none }{ daily rate x N }

\downtime{Celebrate}{ N days }{ - }{ Populated town with popularity }{ Persuasion vs DL }{ reputation }

\downtime{Healing}{N days}{rate per day}{Healer}{ }{ trainer heal rate x N }
