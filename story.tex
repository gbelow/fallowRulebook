...
\textbf{Contacts and reputation:} The contacts and reputation systems are meant to track story progress in terms of character renown and who they know.

\textbf{Playing without Contacts and Reputations} Simply consider that every NPC from the contacts chapter offers their services at base rate. Conduct the game narratively as desired.
...
the result of the character's experiences and can be acquired by engaging in any activity. 
...
\textbf{Disguise:} Use deception + knowledge of a faction or culture as skill when trying to pretend being one of them. 
...
Good renown can can completely bypass the need for reputation. 
...
\begin{proplist}
    ...
    \item \textbf{Celebrating:} explained in downtime.  
    \item \textbf{Persuading:} Successful persuasions can increate trust up to +1.  
\end{proplist} 
...
\textbf{Mercenary morale:} starts at -2 and gets +1 per trust they have in the character.
...
\begin{proplist}
    ...
    \item \textbf{Healer:} speeds up healing injuries and wounds. Heals 8 IL per day, costs 1 GP per day. Higher level: reattach limb. \\
...
\begin{stattable}{Training costs}{@{}lccccp{2.4cm}cc@{}}
Level & 1 & 2 & 3 & 4 & 5 & 6 \\
\midrule
\rowcolor{fallowtint}
Price & 1 SP & 2 SP & 4 SP & 1 GP & 2 GP & +++ \\[3pt]
\end{stattable}
...
\downtime{Job}{ N days }{ - }{Employer}{ arbitrary skill vs DL }{ daily rate x N, gain contact on good DL. }

\downtime{Celebrate}{ N days x living costs }{ - }{ Populated town with popularity }{ Persuasion vs DL }{ Acquires contacts. Increases popularity temporarily.  }

\downtime{Healing}{N days}{rate per day}{Healer}{ }{ trainer heal rate x N. Heals wounds. }
...
%finish saying what better living yields
The cost of living changes from town to town. This table is an average.

\begin{stattable}{Cost of Living}{@{}lcc@{}}
Level & Cost & Health    \\
\midrule
Miserable & 1CP/day & -2  \\
\rowcolor{fallowtint}
...
Living lavishly automatically increases popularity by 1.

Living rich and lavish shows wealth. Wealth oriented NPCs will receive characters better.

Higher standard of living makes for better celebrations. The odds of acquiring a better contact are higher.

\section{Reputation}


There are 2 forms of reputation: Renown and Morality. Each NPC has a different level of reputation required to affect them.

\textbf{Renown:} ranges from 0 to 10
Renown means that the character is considered more competent, and important. Many characters will automatically treat characters as contacts when they have high renown. \\
...
\textbf{Morality:}  ranges from -10 to 10 \\
Morality is the reputation for being cruel, aggressive, or a liar.  \\
Characters with high notoriety will be called for immoral or illegal tasks.

\textbf{Popularity:} is tracked from city to city. NPCs have a minimum popularity they require a character to have before they recognize them without the need for a test. This is gained by maintaining influencer contacts.
The amount of popularity is equal to the strength of the most influential Influencer that is a contact. Popularity may get temporary boosts from celebration.

\subsection{Missions}

\textbf{Mission reputation requirements: }Missions have a renown and morality requirement, bonus per completion and maximum. The method and quality of completion influence how much renown and morality is gained. 

\textbf{Usurping reputation:} The team can claim to have completed a mission by celebrating. The actual people who completed the mission will not like this. 

Mission skeleton example: 

Requirement: Trust 1 with Noble, Renown: 2. \\
Yield: +1 renown (max 4), 0 morality. \\
Increases trust with noble by 1 (max 2). reduces trust with merchant by -1. \\
Yields 3 karma per participant and 20 GP in total. Yields +1 karma, +10 GP for extra objective. -1 morality if violence happens.\\
