...
\textbf{Intimidation:} The higher the renown, the higher the level of an NPC that can be intimidated in a public scenario. 
...
\begin{proplist}
    ...
    \item \textbf{Moralist:} Treats good characters with trust +1 or bad ones with -1 per Honor level before being a contact.
\end{proplist}
...
\begin{stattable}{Training costs}{@{}lcccccc@{}}
Level & 1 & 2 & 3 & 4 & 5 & 6 \\
\midrule
\rowcolor{fallowtint}
...
\downtime{Job}{ N days }{ - }{Employer}{ arbitrary skill or knowledge vs DL }{ 
    ...
    A miss loses 2 renown. A graze loses 1 renown.
}

\downtime{Celebrate}{ lasts 10 days, Living standard x 10. Can be more expensive for larger regions. }{ - }{ Populated town and a deed or mission. Only one deed or mission can be celebrated at a time, unless the deed was part of the mission.}{ Persuasion or deception vs DL. DL increases for lack of evidence and lack of previous renown. DL decreases by 1 by increasing duration by 10 days, with a maximum of 30 days.}{ 
...
Level & Cost & Health & Renown   \\
\midrule
Miserable & 1CP/day & -2 & zero  \\
\rowcolor{fallowtint}
Poor & 5CP/day & 0 & 2 \\
Medium & 1SP/day & +2 & 4 \\
\rowcolor{fallowtint}
