...
The more specific the player is about what their character is doing, the less a test becomes necessary. Simply concede that what they are trying to do works. Sometimes, a player may describe a correct course of action for their character because of their knowledge as a player. If that action is suspected to be beyond the character's abilities, the advice is to ask for a skill check to determine if the character would really do or know that. Conversely, often the character is smarter than the player, so the player can ask the character if they would know something through a test.
...
\begin{itemize}
  \item \textbf{Negotiation:} Happens at the morale test. Switches combat to social for some time and can lead to capitulation.
