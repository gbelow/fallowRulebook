...
\textbf{How to do it?:} Social actions are performed through character interpretation. A character says or does something and declares the social action they are trying to perform. A rhetoric, manipulation or will test is made against oponent corresponding skill, and the effects of the action are resolved. A test can be made with a combination of skills, for example rhetoric+manipulation or will+manipulation. Add all of the skills pertinent to the interaction. If the social action is performed within a combat context, the Master may decide to require a certain amount of Action Points (AP) to perform it. 
...
The social actions are separated to define the outcome, not the skill to execute them. Any out of rhetoric, manipulation or will can be used for any action, as long as it makes sense. 
...
\textbf{Intimidate:} is an attempt to instill fear in someone or to persuade through threat. For the intimidation IB, one must analyze the likelihood of the threat being carried out and the cost of accepting the threat. 
...
\textbf{Distract:} The goal is to capture the attention of one or more characters. It is an stress or charm test against cunning. If done against a crowd, roll against the character who is hardest to distract.
...
Any social action that requires someone to be a contact gets an immediate -5 to the acting skill if they are not one. This means that the situation can still be resolved in roleplay, but the mechanical one is much more difficult.
...
\textbf{Impress:} Impress is a mechanic used exclusively in roleplaying. The goal of impressing is to make a character consider you a contact temporarily. This is a persuasion or intimidation test, depending on the situation. On successes or criticals, the target considers you a contact until the end of the interaction or until trust is betrayed.
