...
\textbf{General Knowledge:} in the absence of specific knowledge of the region, use Awareness + $knowledge/2$, where knowledge is one of the general knowledges. Use survival for searching and tracking in the wilderness, geography for traveling, and architecture for tunnels and large structures. The general knowledge is not as good as specific, but it helps.
