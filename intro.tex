...
\textbf{Strategy and risk management.} This game is not about kicking the door and seeing what is inside. It is about making an informed decision before going in. There are many ways to approach a situation and not every strategy is meant to be viable. Sometimes, one strategy will dominate another, even if the losing side has better individual stats. Even low skilled characters are meant to remain a threat throughout the levels of play. The game philosophy is to give information beforehand, and allow players to prepare for it. 
