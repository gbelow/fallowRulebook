...
\textbf{Injury (IL):} penalties affect STR, AGI, STA. This does not affect movement speeds, nor TGH. It affects all other usages.
...
\begin{itemize}
    ...
    \item \textbf{Camouflage in plain sight:} -5 to Stealth vs vision when in plain sight.
...
\begin{itemize}
    ...
    \item injured: +2 per injury penalty
