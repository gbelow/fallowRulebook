...
\begin{itemize}
    ...
    \item Combat surge: 3 STA to gain 6 AP that can be used for melee and ranged attacks or movement and must be used immediately.
...
If the distance is still at close when hiding, the opponent has the option of leaving. If they don't, the fugitives will have to risk being detected again to sneak away in another stealth event to end the chase.
