...
\textbf{Combat morale test:} At the beginning of each round, all characters make a will test against the DL of the terror of the moment. A graze leaves the character afraid, and a miss activates the character's limit stress action. The limit stress action only triggers if there is an enemy within 30m.
...
\textbf{Rally:} Say something encouraging in combat. This decreases the DL of allies next morale test by $1 + character's charisma/2$. This can be done during a reaction surge. Multiple Rallies don't stack. Only the highest one counts.
