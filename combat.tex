...
\textbf{Success Overflow:} When a character receives a hit from an attack, they may receive additional effects, chosen by the attacker. Every point above a hit can be used to activate these effects. These points are called Success Overflow Points(SOP). The effects are:
