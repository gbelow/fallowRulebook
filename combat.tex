...
\textbf{Healing Injuries:} characters heal by resting well and using potions or medicine. Any time the injury level is healed, the character must spend 1 hunger and 1 thirst unless otherwise stated by the specific healing method.
...
\textbf{Head:} Costs 5 points. Getting a wound or stun to the head causes unconsciousness. The head has a 50\% chance of a wound on tier 1 and 100\% on tier 2 when receiving blunt damage. Tier 4+ damage has 50\% chance of instant death. Bypassing armor is possible with any weapon, unless the helmet is closed.
...
\textbf{Injury (IL):} penalties affect Grapple, Climb, Swim, and Will. 
...
\textbf{Damage from Impact with objects:} Depends entirely on what is hitting what at what speed and whether one object is fixated or free. Estimate what tier of injury the impact would cause and match the damage to correspond to it. Range between 5 to 10 damage per expected tier of injury. 
