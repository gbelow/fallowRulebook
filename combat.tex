...
\begin{proplist}
    ...
    \item \textbf{Focus surge:} Gains no AP, but this surge is required to use shooting weapons, casting spells and using items that are not currently hand held.
\end{proplist}
...
\item \textbf{Grappled:} Movement requires a test. Focus is locked to the main grappler.
...
\textbf{Attack and Defend:} Strikes between opponents involved in a grapple can be done with short range attacks. It is not possible to evade or block attacks, only intercept. Once grappled, a character will center its focus on its grappler and cannot shift it to another for the purposes of flanking o blocking projectiles. Any attacks with the grappling property can use the grapple skill instead of strike to attack during a grapple.
