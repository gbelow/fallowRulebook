...
\textbf{Guard:} If using a shield, they can spend 2 AP to block ranged attacks against themselves or adjacent characters, as long as they are closer to the projectile source than the adjacent character. Shield Cover is added to guard as a bonus. On graze, the attack damage is reduced by the block value. On a miss, by 1.5x as much. Hits and crits damage the character directly.
