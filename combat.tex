...
\begin{itemize}
    ...
    \item Reaction surge: 3 STA to gain 6 AP, but can only use reactions until the end of the round.
...
\textbf{Combat morale test:} At the beginning of each round, all characters make a will test against the DL of the terror of the moment. A graze leaves the character frightened, and a failure activates the character's limit stress action.
...
Every social action costs 4 AP +1 STA and counts as a Rest action.

\textbf{Intimidation:} A character can make an intimidation attempt in combat. This increases the value of the DL of the next morale test by the character's charisma. This can be done during a combat surge.

Multiple intimidations and taunts don't stack. Only the highest charisma counts.

\textbf{Taunt:} In combat, a taunt modifies the next morale test to make enemies enraged instead of afraid. 
...
% \textbf{Feign Death:} The character becomes immobile and prone. Anyone trying to target them has to hit or crit on an insight or cunning test against deception, or be forced to do something else. WHAT ABOUT CRUELTY STABS? WHAT ABOUT THROWING AOE ON THE SIDE? WHAT ABOUT AFTER COMBAT? 

% \textbf{Truce:} A persuasion test against the highest between insight or cunning in the enemy team to attempt to stop the fight. Only intelligent creatures capable of communication can accept this.

\textbf{Negotiation:} This is a persuasion test against the highest between insight or cunning of the leader of the opponent team. It is a social test and adds IB, just like as explained in the intrigue section. Only intelligent creatures capable of communication can accept this. The point of negotiation is to promote a truce or demand capitulation. If the truce is accepted or capitulation is offered, the combat ends.
