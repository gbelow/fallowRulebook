...
\begin{proplist}
    ...
    \item \textbf{Combat surge:} 3 STA to gain 4 AP that can be used for attacks or movement and must be used immediately.
...
\textbf{Trample:} Happens when two characters hit each other at speed. This is a Force vs Force comparison. If the runner's Force is higher, the opponent moves back one space x MM. If Force is 5 points higher or more, the opponent is prone. Whoever is running or jumping gets a bonus equal to their running or jumping speed to this. If the defender's force is equal or higher, the runner is stopped. If a strike started this action, targeting the head increases attacker's force by 5.
