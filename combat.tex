...
\begin{proplist}
    ...
    \item \textbf{Focus surge:} 1 STA to gain 2 AP. The AP is free to use for anything. This surge is required to use shooting weapons, casting spells and utilizing non weapon items.
\end{proplist}
