...
When falling, the DL to fall properly is generally proportional to the fall height. Falls from small heights in a bad position are more difficult too.

\textbf{Fall skill test:} A critical on the balance test reduces the damage by 50\%, a success by 25\%, a graze by nothing, and a miss hits the head. Crits and hits prevent T0 and T1 injuries. Receiving a T2 injury or higher or receiving graze or miss makes the character prone.

\textbf{Fall damage} For this damage estimation, consider that the landing spot is a flat, hard surface. The DM is the character's DM and the damage ignores armor. To estimate fall damage, do 2x fall height x DM$^2$. Maximum height is capped at 50m. Soft surfaces, like sand halve the damage and liquids make it a quarter.
...
\begin{itemize}
    ...
    \item Shocked: cause immobile. Happens with damage to the chest. Has 50\% chance on a T4 hit and 100\% chance on a T5. 
...
Here are a few common flammable surfaces and the amount of burning damage they cause when covereing the same space as a character. 
...
\hline\hline
Dry grass, thatch & 8 & 1/round\\
Oil film & 8 & 3/round \\
Pitch, tar, resin & 12 & sticks \\
Wood pyre, timber & 12 & 0 \\
\hline
\end{tabular}
\end{center}
