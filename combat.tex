...
\textbf{End of the round:} A round ends when no one has AP left and the remaining agree to end the round. When the round ends, all characters get reset to 6 AP minus any negative AP they had. Any unspent AP is lost. AP loss can be prevented by pooling AP from both rounds to rest, which happens at the beginning of the next round.

\textbf{Rest:} is an action that costs 4 AP and recovers STA by an amount equal to STA/4. The character is allowed to move 4 AP worth of careful movement while resting. 
