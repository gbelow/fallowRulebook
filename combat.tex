...
\textbf{Pushing objects:} To push an object, or when struck by one, use the push action as described in Grapple, but use the skill value of STR as a skill instead. A hit stops the object and moves it in any direction by 1m per 3 SOP. When struck by an object, in a graze, the object can be redirected by up to 60 degrees.
